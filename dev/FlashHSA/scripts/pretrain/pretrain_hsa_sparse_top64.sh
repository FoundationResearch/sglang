...
bash train.sh tasks/pretrain.py configs/baselines/full_attn_tiny.yaml \
    --model.config_path configs/flash_hsa/config_nope_top64.json \
    ...
    --train.rmpad false \
    --train.wandb_name hsa_sparse_top64 \
    ...
    --train.output_dir /apdcephfs_sh8/share_300719895/shawnxxxhu/checkpoints/hsa-nope-top64
