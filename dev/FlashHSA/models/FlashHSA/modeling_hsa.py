    ...
    def forward(self,
        ...
        **kwargs,
        ...
        if shared_kv is not None:
            ...
            # hsa: (B, L, h_kv, d)
            chunk_lmks = swa_k[:, self.chunk_size-1::self.chunk_size, :, :] # (B, L // cz, h_kv, d)
        ...
        if self.hsa_mode == 'sparse':
            ...
            hsa_o = self.hsa_func(q_norm, hsa_k_norm, hsa_v, chunk_weights, indices, block_size=self.chunk_size, mask_last_token=True)  # 添加block_size参数
