...
export MODEL_CONFIG="configs/olmo3_7B/olmo3_lhsa_interleave_8KA1K_non_unified_layerqk_w_noise.json"
export MODEL_PATH="/apdcephfs_tj5/share_300719894/user/guhao/Models/lhsa-olmo3-interleave-8KA1K-non-unified-layerqk-w-noise-64gpu/global_step_11000/hf_ckpt"
export CORPUS_PATH="/apdcephfs_tj5/share_300719894/shared/data/dolma3_mix-6T-1025-500B/"
export MAX_SEQ_LEN=8192
export WANDB_NAME="lhsa-olmo3-interleave-8KA1K-non-unified-layerqk-w-noise"
export OUTPUT_DIR="/apdcephfs_tj5/share_300719894/user/guhao/checkpoints/lhsa-olmo3-interleave-8KA1K-non-unified-layerqk-w-noise-64gpu/"
export LOAD_CHECKPOINT_PATH="/apdcephfs_tj5/share_300719894/user/guhao/checkpoints/lhsa-olmo3-interleave-8KA1K-non-unified-layerqk-w-noise-64gpu/global_step_12000/"
