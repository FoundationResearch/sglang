...
export MODEL_CONFIG="configs/olmo3_7B/olmo3_lhsa_half_pope_swa512_lmkmask_headqk_wnoise.json"
...
export WANDB_NAME="lhsa-olmo3-half-pope-swa512-lmkmask-wo-softmax1-noise[0.5,0.2]"
export OUTPUT_DIR="/apdcephfs_tj5/share_300719894/user/guhao/checkpoints/lhsa-olmo3-half-pope-swa512-lmkmask-wosoftmax1-wnoise"
