...
export MODEL_CONFIG="configs/olmo3_7B/olmo3_lhsa_8KA2K_alibi.json"
export MODEL_PATH="/apdcephfs_tj5/share_300719894/user/guhao/checkpoints/lhsa-olmo3-7B-8KA2K-alibi-remove-fullattn"
export CORPUS_PATH="/apdcephfs_tj5/share_300719894/shared/data/dolma3_mix-6T-1025-500B/"
export MAX_SEQ_LEN=8192
export WANDB_NAME="lhsa-olmo3-8KA2K-alibi-[0.5, 0.2]-stage1"
export OUTPUT_DIR="/apdcephfs_tj5/share_300719894/user/guhao/checkpoints/lhsa-olmo3-7B-8KA2K-alibi-stage1"
...
export EXTRA_ARGS="\
  --train.wandb_project alibi_stage1 \
