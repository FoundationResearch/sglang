...
bash train.sh tasks/ruler_sft.py configs/baselines/full_attn_tiny_cos.yaml \
    --model.config_path configs/swan_gpt_tiny/config_std.json \
    ...
    --train.wandb_name swan_gpt_tiny_std \
    --train.rmpad false \
    ...
    --train.output_dir /apdcephfs_fsgm/share_303843174/user/qqzxywei/wxy/checkpoints/swan-gpt-std-ruler \
    --model.model_path /apdcephfs_fsgm/share_303843174/user/qqzxywei/wxy/checkpoints/swan-gpt-std \
