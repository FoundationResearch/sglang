...
bash train.sh tasks/ruler_sft.py configs/baselines/full_attn_tiny_cos.yaml \
    --model.config_path configs/flash_hsa/config_swan_lmk_win512.json \
    ...
    --train.wandb_name swan_lmk_win512 \
    --train.rmpad false \
    ...
    --train.output_dir /apdcephfs_fsgm/share_303843174/user/qqzxywei/wxy/checkpoints/swan_lmk_win512_step20000-ruler \
    --model.model_path /apdcephfs_sh8/share_300719895/shawnxxxhu/checkpoints/lmk-swan/checkpoints/global_step_20000/hf_ckpt \
