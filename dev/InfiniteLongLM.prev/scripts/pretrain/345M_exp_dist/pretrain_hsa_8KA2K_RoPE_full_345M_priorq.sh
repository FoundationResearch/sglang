...
export MODEL_CONFIG="configs/flash_hsa/config_hsa_8KA2K_RoPE_345M_priorq.json"
export CORPUS_PATH="/apdcephfs_tj5/share_300719894/shared/data/dolma3_mix-6T-1025-partial-tokenized/"
export MAX_SEQ_LEN=8192
export WANDB_NAME="hsa_8KA2K_RoPE_full_345M_priorq"
export OUTPUT_DIR="/apdcephfs_tj5/share_300719894/user/qqzxywei/wxy/checkpoints/hsa_8KA2K_RoPE_full_345M_dist_priorq"
