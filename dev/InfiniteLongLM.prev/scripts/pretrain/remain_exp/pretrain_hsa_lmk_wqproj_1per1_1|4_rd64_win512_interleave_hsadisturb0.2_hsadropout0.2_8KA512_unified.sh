...
export WANDB_NAME="hsa-interleave-win512-hsadisturb0.2-hsadropout0.2-8KA512-unified-ruler-single"
export OUTPUT_DIR="/apdcephfs_fsgm/share_303843174/user/qqzxywei/wxy/checkpoints/hsa-interleave-win512-hsadisturb0.2-hsadropout0.2-8KA512-unified-ruler-5per-single"
