...
def main(args):
    ...
    HSAForCausalLM = resolve_hsa_class(args.config_path, args.checkpoint_path)
...
python eval/eval_ruler_hf.py \
    ...
    --checkpoint_path /apdcephfs_fsgm/share_303843174/user/guhao/Models/lhsa-olmo3-7B-dropout-fix-swa-mlp-40B-stage1/global_step_1000/hf_ckpt/ \
    --task_id 0 \
    --segment_size -1 \
    --max_seq_len $((16*1024)) \
    --max_samples 100 \
