...
def load_model(args, auto_insert_lmk):
    ...
    HSAForCausalLM.config_class = DebugHSAConfig
    AutoModelForCausalLM.register(DebugHSAConfig, HSAForCausalLM, exist_ok=True)
