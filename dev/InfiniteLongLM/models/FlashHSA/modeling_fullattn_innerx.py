...
class HierarchicalSparseAttention(nn.Module):
    ...
    def forward(self,
        ...
        **kwargs,
        ...
        hsa_q_norm = hsa_q_norm.transpose(1, 2)
        hsa_k_norm = hsa_k_norm.transpose(1, 2)
        hsa_v = hsa_v.transpose(1, 2)
        ...
        swa_o, _ = attention_interface(
            ...
            sliding_window=self.sliding_window,  # swa
            **kwargs,
        )  # (B, L, h_q // 2, d)

        # replace hsa with full-attn
        hsa_o, _ = attention_interface(
            self,
            hsa_q_norm,
            hsa_k_norm,
            hsa_v,
