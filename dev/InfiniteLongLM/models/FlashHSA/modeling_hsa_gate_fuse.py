...
class HierarchicalSparseAttention(nn.Module):
    def __init__(self, config, layer_idx):
        ...
        self.g_proj = nn.Linear(self.d_model, self.num_heads * 2, bias=False)
    ...
    def forward(self,
        ...
        **kwargs,
        ...
        g = rearrange(self.g_proj(hidden_states), '... (h d) -> ... h d', d=2)
        g_swa, g_hsa = g.sigmoid().unbind(-1)  # (B, L,)
        ...
        o = swa_o * g_swa.unsqueeze(-1) + hsa_o * g_hsa.unsqueeze(-1)
