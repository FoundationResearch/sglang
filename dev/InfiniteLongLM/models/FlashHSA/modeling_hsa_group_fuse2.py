...
class HierarchicalSparseAttention(nn.Module):
    def __init__(self, config, layer_idx):
        ...
        self.lmk_q_proj = nn.Linear(self.d_model, self.d_kv, bias=False)
    ...
    def forward(self,
        ...
        **kwargs,
        ...
        indices, scores = self.topk_func(lmk_q_norm, chunk_lmks, self.topk, self.chunk_size, window_size=self.window_size, is_causal=True)  # (B, L, h_q, k), scores should be differential
