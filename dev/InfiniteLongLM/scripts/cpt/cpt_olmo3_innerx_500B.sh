...
export WANDB_NAME="lhsa-olmo3-innerx-lr3e-5-drop0.2-disturb0.2"
export OUTPUT_DIR="/apdcephfs_sh8/share_300719895/guhao/checkpoints/lhsa-olmo3-innerx-lr3e-5"
...
LOG_DIR="/apdcephfs_fsgm/share_303843174/user/guhao/InfiniteLongLM/scripts/cpt/logs"
mkdir -p "$LOG_DIR"
LOG_FILE="${LOG_DIR}/${WANDB_NAME}_$(date +%Y%m%d_%H%M%S).log"
