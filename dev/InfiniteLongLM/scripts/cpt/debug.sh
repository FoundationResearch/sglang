...
export WANDB_NAME="olmo3_debug_no_grad_ckpt"
...
# export EXTRA_ARGS="$EXTRA_ARGS --model.attn_implementation sdpa"
# export EXTRA_ARGS="$EXTRA_ARGS --train.enable_mixed_precision false"
# export EXTRA_ARGS="$EXTRA_ARGS --train.enable_gradient_checkpointing false"
