...
# ── Copy initial weights from CephFS to local disk ──────────────────────────
# Each node copies once (before torchrun spawns 8 GPU processes), avoiding
# 64 processes hammering CephFS simultaneously and causing I/O hangs.
CEPH_MODEL_PATH="/apdcephfs_tj5/share_300719894/user/guhao/checkpoints/lhsa-olmo3-7B-8KA2K-w-lmk-q-proj-4k-swa-mask_lmk"
LOCAL_MODEL_PATH="/root/local_ckpt/lhsa-olmo3-7B-8KA2K-w-lmk-q-proj-4k-swa-mask_lmk"
...
export WANDB_NAME="lhsa-olmo3-8KA2K-w-lmk-q-proj-4k-swa-mask_lmk"
export OUTPUT_DIR="/apdcephfs_tj5/share_300719894/user/guhao/checkpoints/lhsa-olmo3-7B-8KA2K-w-lmk-q-proj-4k-swa-mask_lmk"
