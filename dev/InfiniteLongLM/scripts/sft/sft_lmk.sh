...
CORPUS_PATH=${CORPUS_PATH:-"/apdcephfs_sh8/share_300719895/shared/data/Dolci-Instruct-SFT-parquet"}
MAX_SEQ_LEN=${MAX_SEQ_LEN:-32768}
CHUNK_SIZE=${CHUNK_SIZE:-64}
WANDB_NAME=${WANDB_NAME:-"sft-lmk"}
OUTPUT_DIR=${OUTPUT_DIR:-"/apdcephfs_sh8/share_300719895/shawnxxxhu/checkpoints/sft-lmk-debug"}
