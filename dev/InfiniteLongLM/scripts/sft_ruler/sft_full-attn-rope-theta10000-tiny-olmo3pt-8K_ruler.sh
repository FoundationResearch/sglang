...
bash train.sh tasks/ruler_sft.py configs/baselines/full_attn_tiny_cos.yaml \
    ...
    --train.output_dir /apdcephfs_fsgm/share_303843174/user/qqzxywei/wxy/checkpoints/full-attn-rope-theta10000-tiny-olmo3pt-8K-ruler\
    --model.model_path /apdcephfs_fsgm/share_303843174/user/qqzxywei/wxy/checkpoints/full-attn-rope-theta10000-tiny-olmo3pt-8K \
