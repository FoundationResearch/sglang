...
bash train.sh tasks/ruler_sft.py configs/baselines/full_attn_tiny_cos.yaml \
    --model.config_path configs/flash_hsa/config_nope_top32_win512.json \
    ...
    --train.wandb_name hsa_sparse_swan_top32_win512-ruler \
    --train.rmpad false \
    ...
    --train.output_dir /apdcephfs_fsgm/share_303843174/user/qqzxywei/wxy/checkpoints/hsa_sparse_swan_top32_win512-ruler \
    --model.model_path /apdcephfs_fsgm/share_303843174/user/qqzxywei/wxy/checkpoints/hsa_sparse_swan_top32_win512 \
