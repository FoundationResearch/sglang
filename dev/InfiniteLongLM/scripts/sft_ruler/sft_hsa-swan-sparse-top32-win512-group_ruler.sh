...
bash train.sh tasks/ruler_sft.py configs/baselines/full_attn_tiny_cos.yaml \
    --model.config_path configs/flash_hsa/config_swan_nope_sparse_group.json \
    ...
    --train.wandb_name hsa_sparse_swan_top32_win512_group-ruler \
    --train.rmpad false \
    ...
    --train.output_dir /apdcephfs_fsgm/share_303843174/user/qqzxywei/wxy/checkpoints/hsa_sparse_swan_top32_win512_group-ruler \
    --model.model_path /apdcephfs_sh8/share_300719895/shawnxxxhu/checkpoints/hsa-swan-group-top32-win512/checkpoints/global_step_20000/hf_ckpt \
