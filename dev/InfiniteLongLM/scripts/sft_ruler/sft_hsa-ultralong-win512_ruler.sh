...
bash train.sh tasks/ruler_sft.py configs/baselines/full_attn_tiny_cos.yaml \
    --model.config_path configs/hsa_ultralong/hsa-swa-2group.json \
    ...
    --train.wandb_name hsa_ultralong_win512_step20000_ruler \
    --train.rmpad false \
    ...
    --train.output_dir /apdcephfs_fsgm/share_303843174/user/qqzxywei/wxy/checkpoints/hsa-ultralong-win512-step20000-ruler \
    --model.model_path /apdcephfs_fsgm/share_303843174/user/qqzxywei/wxy/checkpoints/hsa-ultralong-win512-step20000/hf_ckpt \
