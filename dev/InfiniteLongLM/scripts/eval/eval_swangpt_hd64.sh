...
#         --config_path configs/swan_gpt_tiny/config_std_hd64.json \
#         --vocab_dir ./configs/olmo3_vocab/ \
#         --checkpoint_path /apdcephfs_fsgm/share_303843174/user/qqzxywei/wxy/checkpoints/swangpt-ruler-5per-single/checkpoints/global_step_30000 \
