...
#         --config_path configs/flash_hsa/config_swan_nope_sparse_innerx_stage2_win512_retrievaldim128.json \
#         --vocab_dir ./configs/olmo3_vocab/ \
#         --checkpoint_path /apdcephfs_sh8/share_300719895/shawnxxxhu/checkpoints/hsa-innerx-top32-stage2-win512-retrievaldim128/checkpoints/global_step_25000 \
...
python eval/eval_ruler.py \
    --config_path configs/flash_hsa/config_swan_nope_sparse_innerx_stage1_win128_retrievaldim128.json  \
    --vocab_dir configs/olmo3_vocab/ \
