...
for MAX_SEQ_LEN in "${SEQ_LEN_LIST[@]}"; do
    ...
    python eval/eval_ppl.py \
        ...
        --checkpoint_path /apdcephfs_sh8/share_300719895/shawnxxxhu/checkpoints/hsa-swan-innerx-top32-win512-ruler/checkpoints/global_step_10000 \
...
for MAX_SEQ_LEN in "${SEQ_LEN_LIST[@]}"; do
    ...
    python eval/eval_ppl.py \
        --config_path configs/flash_hsa/config_swan_nope_sparse_innerx.json \
        --vocab_dir ./configs/olmo3_vocab/ \
        --checkpoint_path /apdcephfs_sh8/share_300719895/shawnxxxhu/checkpoints/hsa-swan-innerx-top32-win512-ruler/checkpoints/global_step_30000 \
        --data_path /apdcephfs_sh8/share_300719895/shared/data/dolma3_mix-6T-1025-partial-tokenized \
        --max_seq_len $MAX_SEQ_LEN \
        --insert_lmk \
        --max_samples 1000 \
...
# CUDA_LAUNCH_BLOCKING=1 python eval/eval_ruler.py \
#     --config_path configs/flash_hsa/config_swan_nope_sparse_innerx.json  \
#     --vocab_dir configs/olmo3_vocab/ \
#     --corpus_path /apdcephfs_sh8/share_300719895/shared/data/dolma3_mix-6T-1025-partial-tokenized/ \
#     --checkpoint_path /apdcephfs_sh8/share_300719895/shawnxxxhu/checkpoints/hsa-swan-innerx-top32-win512-ruler/checkpoints/global_step_10000 \
