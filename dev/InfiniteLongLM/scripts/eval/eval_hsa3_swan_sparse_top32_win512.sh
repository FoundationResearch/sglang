...
#         --checkpoint_path /apdcephfs_sh8/share_300719895/shawnxxxhu/checkpoints/hsa3-swan-top32-win512-ruler/checkpoints/global_step_10000 \
...
for MAX_SEQ_LEN in "${SEQ_LEN_LIST[@]}"; do
    ...
    python eval/eval_ppl.py \
        --config_path configs/flash_hsa/config_swan_hsa3_sparse.json \
        --vocab_dir ./configs/olmo3_vocab/ \
        --checkpoint_path /apdcephfs_sh8/share_300719895/shawnxxxhu/checkpoints/hsa3-swan-top32-win512-ruler/checkpoints/global_step_30000 \
        --data_path /apdcephfs_sh8/share_300719895/shared/data/dolma3_mix-6T-1025-partial-tokenized \
        --max_seq_len $MAX_SEQ_LEN \
        --insert_lmk \
        --max_samples 1000 \
