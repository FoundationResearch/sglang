...
for MAX_SEQ_LEN in "${SEQ_LEN_LIST[@]}"; do
    ...
    python eval/eval_ppl.py \
        --config_path configs/flash_hsa/config_swan_stb_sparse_innerx_win512.json \
        --vocab_dir ./configs/olmo3_vocab/ \
        --checkpoint_path /apdcephfs_sh8/share_300719895/shawnxxxhu/checkpoints/hsa-innerx-stb-1per2-top32-win512-ruler/checkpoints/global_step_10000 \
