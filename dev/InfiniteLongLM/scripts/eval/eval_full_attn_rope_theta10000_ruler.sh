...
for MAX_SEQ_LEN in "${SEQ_LEN_LIST[@]}"; do
    ...
    python eval/eval_ppl.py \
        ...
        --checkpoint_path /apdcephfs_sh8/share_300719895/shawnxxxhu/checkpoints/full-attn-rope-theta10000-ruler/checkpoints/global_step_30000 \
...
python eval/eval_ruler.py \
    ...
    --checkpoint_path /apdcephfs_sh8/share_300719895/shawnxxxhu/checkpoints/full-attn-rope-theta10000-ruler/checkpoints/global_step_10000 \
    --task_id $TASK_ID \
    --segment_size -1 \
    --max_seq_len $((8*1024))  \
    --max_samples 100 \
