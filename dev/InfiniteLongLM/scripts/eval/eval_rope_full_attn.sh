...
# eval ruler for full attn rope
python eval/eval_ruler.py \
    --config_path configs/swan_gpt_tiny/config_rope_full_theta10000.json  \
    --vocab_dir configs/olmo3_vocab/ \
    --corpus_path /apdcephfs_sh8/share_300719895/shared/data/dolma3_mix-6T-1025-partial-tokenized/ \
    --checkpoint_path /apdcephfs_fsgm/share_303843174/user/qqzxywei/wxy/checkpoints/full-attn-rope-theta10000-tiny-olmo3pt-8K-ruler/checkpoints/global_step_3000 \
    --task_id 1 \
    --segment_size -1 \
    --max_seq_len $((64*1024))  \
    --max_samples 100 \
