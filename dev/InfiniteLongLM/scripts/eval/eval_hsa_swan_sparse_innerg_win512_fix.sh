...
#         --config_path configs/flash_hsa/config_swan_nope_sparse_innerg_win512.json \
#         --vocab_dir ./configs/olmo3_vocab/ \
#         --checkpoint_path /apdcephfs_sh8/share_300719895/shawnxxxhu/checkpoints/hsa-swan-innerg-top32-win512-ruler-fix/checkpoints/global_step_30000 \
