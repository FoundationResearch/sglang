...
#         --config_path configs/flash_hsa/config_swan_nope_sparse_innerx_stage2_win512_retrievaldim512.json \
#         --vocab_dir ./configs/olmo3_vocab/ \
#         --checkpoint_path /apdcephfs_sh8/share_300719895/shawnxxxhu/checkpoints/hsa-innerx-top32-stage2-win512-retrievaldim512/checkpoints/global_step_25000 \
