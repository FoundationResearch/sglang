...
for MAX_SEQ_LEN in "${SEQ_LEN_LIST[@]}"; do
    ...
    python eval/eval_ppl.py \
        --config_path configs/flash_hsa/config_hsa_ultra_win512_1per2_stb.json \
        --vocab_dir ./configs/olmo3_vocab/ \
        --checkpoint_path /apdcephfs_sh8/share_300719895/shawnxxxhu/checkpoints/hsa-ultra-1per2-stb-top32-win512-ruler/checkpoints/global_step_10000 \
...
python eval/eval_ruler.py \
    ...
    --checkpoint_path /apdcephfs_sh8/share_300719895/shawnxxxhu/checkpoints/hsa-ultra-1per2-stb-top32-win512-ruler/checkpoints/global_step_30000 \
    --task_id $TASK_ID \
    --segment_size -1 \
    --max_seq_len $((8*1024))  \
    --max_samples 100 \
