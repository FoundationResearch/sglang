...
#         --config_path configs/flash_hsa/config_hsa_ultra_win512_adjlmk.json \
#         --vocab_dir ./configs/olmo3_vocab/ \
#         --checkpoint_path /apdcephfs_sh8/share_300719895/shawnxxxhu/checkpoints/hsa-ultra-top32-win512-ruler/checkpoints/global_step_10000 \
