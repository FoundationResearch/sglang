...
MODEL_NAMES=(
    param_reuse_step9537
    # -----------------------------
    lhsa_dropout_step8000
    lhsa_dropout_step9537
    # -----------------------------
    lhsa_dropout_fix_swa_mlp_step5000
    lhsa_dropout_fix_swa_mlp_step6000
    lhsa_dropout_fix_swa_mlp_step7000
)
...
CKPT_PATHS=(
    /apdcephfs_fsgm/share_303843174/user/guhao/Models/olmo3_param_reuse_trainall_40B/global_step_9537/hf_ckpt/
    # -----------------------------
    /apdcephfs_fsgm/share_303843174/user/guhao/Models/lhsa-olmo3-7B-dropout-trainall-40B/global_step_8000/hf_ckpt/
    /apdcephfs_fsgm/share_303843174/user/guhao/Models/lhsa-olmo3-7B-dropout-trainall-40B/global_step_9537/hf_ckpt/
    # -----------------------------
    /apdcephfs_fsgm/share_303843174/user/guhao/Models/lhsa-olmo3-7B-dropout-fix-swa-mlp-40B-stage2-3e-4to3e-5/global_step_5000/hf_ckpt/
    /apdcephfs_fsgm/share_303843174/user/guhao/Models/lhsa-olmo3-7B-dropout-fix-swa-mlp-40B-stage2-3e-4to3e-5/global_step_6000/hf_ckpt/
    /apdcephfs_fsgm/share_303843174/user/guhao/Models/lhsa-olmo3-7B-dropout-fix-swa-mlp-40B-stage2-3e-4to3e-5/global_step_7000/hf_ckpt/
)
