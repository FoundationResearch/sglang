...
CUDA_VISIBLE_DEVICES=0,1 torchrun --nproc_per_node=2 eval/eval_ruler_tp.py \
    ...
    --checkpoint_path /apdcephfs_sh8/share_300719895/shawnxxxhu/checkpoints/hsa-swan-cross-ruler/checkpoints/global_step_10000 \
    --task_id 0 \
    --segment_size -1 \
    --max_seq_len $((8*1024))  \
    --max_samples 10 \
