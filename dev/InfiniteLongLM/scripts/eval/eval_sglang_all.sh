...
# attention_backend: "hsa" for HSA models, "" for standard models
MODEL_NAMES=(
    "8KA1K-no-noise-warmup1k-step13000"

    "8KA2K-no-noise-warmup1k-step13000"
)
HSA_CONFIGS=(
...
HF_PATHS=(
    /apdcephfs_fsgm/share_303843174/user/guhao/Models/lhsa-olmo3-interleave-8KA1K-non-unified-no-noise-layerqk-64gpu-warmup1k/global_step_13000/hf_ckpt

    /apdcephfs_fsgm/share_303843174/user/guhao/Models/lhsa-olmo3-interleave-8KA2K-non-unified-no-noise-layerqk-64gpu-warmup1k/global_step_13000/hf_ckpt
