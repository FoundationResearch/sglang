...
bash train.sh tasks/pretrain.py configs/baselines/full_attn_tiny_cos.yaml \
    --model.config_path configs/flash_hsa/config_innerx_stb_win512_memwin8K.json \
    ...
    --train.wandb_name hsa_innerx_stb_top32_win512_memwin8K \
    ...
    --train.output_dir /apdcephfs_sh8/share_300719895/shawnxxxhu/checkpoints/hsa_innerx_stb_top32_win512_memwin8K
