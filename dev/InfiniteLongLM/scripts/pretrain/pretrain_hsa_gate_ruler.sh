...
bash train.sh tasks/ruler_sft.py configs/baselines/full_attn_tiny_cos.yaml \
    --model.config_path configs/flash_hsa/config_swan_nope_sparse_gate.json \
    ...
    --train.wandb_name hsa_swan_gate_ruler \
    ...
    --train.output_dir /apdcephfs_sh8/share_300719895/shawnxxxhu/checkpoints/hsa-swan-gate-ruler
