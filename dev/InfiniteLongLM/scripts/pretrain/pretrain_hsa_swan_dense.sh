...
bash train.sh tasks/pretrain.py configs/baselines/full_attn_tiny_cos.yaml \
    --model.config_path configs/flash_hsa/config_swan_nope_dense.json \
    ...
    --train.rmpad false \
    --train.wandb_name hsa_dense_swan_correct_fixlabels \
    ...
    --train.output_dir /apdcephfs_sh8/share_300719895/shawnxxxhu/checkpoints/hsa-swan-dense-correct-fixlabels
