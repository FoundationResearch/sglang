...
bash train.sh tasks/pretrain.py configs/baselines/full_attn_tiny_cos.yaml \
    --model.config_path configs/flash_hsa/config_nope_top32_win64.json \
    ...
    --train.rmpad false \
    --train.wandb_name hsa_sparse_swan_top32_win64_fixlabels \
    ...
    --train.output_dir /apdcephfs_sh8/share_300719895/shawnxxxhu/checkpoints/hsa-swan-spasrse-top32-win64-fixlabels
