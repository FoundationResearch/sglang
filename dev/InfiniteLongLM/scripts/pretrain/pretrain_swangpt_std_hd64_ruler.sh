...
bash train.sh tasks/ruler_sft.py configs/baselines/full_attn_tiny_cos.yaml \
    --model.config_path configs/swan_gpt_tiny/config_std_hd64.json \
    ...
    --train.wandb_name swan_gpt_std_ruler \
    ...
    --train.output_dir /apdcephfs_sh8/share_300719895/shawnxxxhu/checkpoints/swan-gpt-std-ruler
