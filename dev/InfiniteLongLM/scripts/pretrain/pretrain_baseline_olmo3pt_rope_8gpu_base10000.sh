...
bash train.sh tasks/pretrain.py configs/baselines/full_attn_tiny_cos.yaml \
    ...
    --train.wandb_name full-attn-rope10000-8K \
    --train.rmpad false \
    ...
    --train.save_steps 6000 \
    --train.max_steps 30000 \
    --train.output_dir /apdcephfs_sh8/share_300719895/shawnxxxhu/checkpoints/full-attn-rope-theta10000-tiny-olmo3pt-8K
