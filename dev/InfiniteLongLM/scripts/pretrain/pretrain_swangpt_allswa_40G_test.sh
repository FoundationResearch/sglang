...
bash train.sh tasks/pretrain.py configs/baselines/full_attn_tiny.yaml \
    --model.config_path configs/swan_gpt_tiny/config_all_swa.json \
    --data.train_path /apdcephfs_sh8/share_300719895/shared/data/dolma3_long_tokenized/data/code-meta-reasoning \
    ...
    --train.output_dir /apdcephfs_sh8/share_300719895/shawnxxxhu/checkpoints/swan-gpt-allswa-tiny-baseline
