...
# stage 1
export WANDB_NAME="hsa-innerx-top32-stage1-win128-retrievaldim128"
export OUTPUT_DIR="/apdcephfs_sh8/share_300719895/shawnxxxhu/checkpoints/${WANDB_NAME}"
export MODEL_CONFIG="configs/flash_hsa/config_swan_nope_sparse_innerx_stage1_win128_retrievaldim128.json"
...
export WANDB_NAME="hsa-innerx-top32-stage2-win512-retrievaldim128"
export OUTPUT_DIR="/apdcephfs_sh8/share_300719895/shawnxxxhu/checkpoints/${WANDB_NAME}"
export MODEL_CONFIG="configs/flash_hsa/config_swan_nope_sparse_innerx_stage2_win512_retrievaldim128.json"
