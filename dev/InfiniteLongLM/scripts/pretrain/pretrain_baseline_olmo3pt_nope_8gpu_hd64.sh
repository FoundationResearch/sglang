...
bash train.sh tasks/pretrain.py configs/baselines/full_attn_tiny_cos.yaml \
    --model.config_path configs/swan_gpt_tiny/config_nope_full_hd64.json \
    ...
    --train.wandb_name full-attn-nope-8K-hd64 \
    --train.rmpad false \
    ...
    --train.output_dir /apdcephfs_fsgm/share_303843174/user/shawnxxxhu/checkpoints/full-attn-nope-tiny-olmo3pt-8K-hd64
