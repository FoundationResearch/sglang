...
export MODEL_CONFIG="configs/flash_hsa/config_hsa_8KA2K_partial-RoPE_345M_lmk_bias.json"
export CORPUS_PATH="/apdcephfs_tj5/share_300719894/shared/data/dolma3_mix-6T-1025-partial-tokenized/"
export MAX_SEQ_LEN=8192
export WANDB_NAME="hsa_8KA2K_HoPE-lmk_bias-fix"
export OUTPUT_DIR="/apdcephfs_tj5/share_300719894/user/qqzxywei/wxy/checkpoints/hsa_8KA2K_HoPE_-full_345M_dist_lmk_bias-fix"
