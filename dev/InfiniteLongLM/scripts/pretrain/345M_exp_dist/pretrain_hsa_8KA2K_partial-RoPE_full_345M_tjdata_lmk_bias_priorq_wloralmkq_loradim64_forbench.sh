...
export MODEL_CONFIG="configs/flash_hsa/config_hsa_8KA2K_HoPE_345M_lmk_bias_priorq_wloralmkq_loradim64_forbench.json"
...
export OUTPUT_DIR="/apdcephfs/share_300719895/user/qqzxywei/wxy/checkpoints/hsa_8KA2K_HoPE_full_345M_dist-priorq-wloralmkq-loradim64"
