...
export MODEL_PATH="/apdcephfs_sh8/share_300719895/guhao/checkpoints/olmo3_cpt_64gpu/checkpoints/global_step_13000/hf_ckpt/"
export CORPUS_PATH="${PROJECT_ROOT}/scripts/mid_train/dolmino_mix.yaml"
export MAX_SEQ_LEN=8192
export WANDB_NAME="olmo3_param_reuse_mid_train"
export OUTPUT_DIR="/apdcephfs_sh8/share_300719895/guhao/checkpoints/olmo3_param_reuse_mid_train"
