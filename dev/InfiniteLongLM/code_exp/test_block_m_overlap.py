...
DEFAULT_CKPT   = "/apdcephfs_fsgm/share_303843174/user/guhao/Models/lhsa-olmo3-interleave-8KA512-non-unified-64gpu/global_step_10000/hf_ckpt"
DEFAULT_DATA   = "/apdcephfs_sh8/share_300719895/shared/data/dolma3_mix-6T-1025-partial-tokenized"
...
def _register_hsa_classes(checkpoint_path):
    ...
    HSAForCausalLM.config_class = _HSAConfig
    AutoModelForCausalLM.register(_HSAConfig, HSAForCausalLM, exist_ok=True)
...
class HSATopkCollector:
    """
    通过 hook 收集每个 LandmarkHSA 层在 forward 中调用 topk_func 后的 indices。
    """
    ...
    def _install_hooks(self):
        """Monkey-patch topk_func in each LandmarkHSA layer to capture indices."""
