...
We provide:
1) A minimal contiguous-page scaffold kernel (`hsa_decode_fwd`) useful for early bringup.
2) A real paged-KV kernel (`hsa_decode_paged_fwd`) that gathers KV via `page_table_1`.
